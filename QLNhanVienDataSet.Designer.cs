...
namespace QuanLyMuaBanSach {
    ...
    public partial class QLNhanVienDataSet : global::System.Data.DataSet {
        ...
        public partial class NhanVienDataTable : global::System.Data.TypedTableBase<NhanVienRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public NhanVienRow AddNhanVienRow(string maNV, string tenNV, string gioiTinh, System.DateTime ngaySinh, string SDT, string diaChi) {
...
namespace QuanLyMuaBanSach.QLNhanVienDataSetTableAdapters {
    ...
    public partial class NhanVienTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = @"DELETE FROM [dbo].[NhanVien] WHERE (([maNV] = @Original_maNV) AND ([tenNV] = @Original_tenNV) AND ([gioiTinh] = @Original_gioiTinh) AND ((@IsNull_ngaySinh = 1 AND [ngaySinh] IS NULL) OR ([ngaySinh] = @Original_ngaySinh)) AND ([SDT] = @Original_SDT) AND ((@IsNull_diaChi = 1 AND [diaChi] IS NULL) OR ([diaChi] = @Original_diaChi)))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[NhanVien] ([maNV], [tenNV], [gioiTinh], [ngaySinh], [SDT], [di" +
                "aChi]) VALUES (@maNV, @tenNV, @gioiTinh, @ngaySinh, @SDT, @diaChi);\r\nSELECT maNV" +
                ", tenNV, gioiTinh, ngaySinh, SDT, diaChi FROM NhanVien WHERE (maNV = @maNV)";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[NhanVien] SET [maNV] = @maNV, [tenNV] = @tenNV, [gioiTinh] = @gioiTinh, [ngaySinh] = @ngaySinh, [SDT] = @SDT, [diaChi] = @diaChi WHERE (([maNV] = @Original_maNV) AND ([tenNV] = @Original_tenNV) AND ([gioiTinh] = @Original_gioiTinh) AND ((@IsNull_ngaySinh = 1 AND [ngaySinh] IS NULL) OR ([ngaySinh] = @Original_ngaySinh)) AND ([SDT] = @Original_SDT) AND ((@IsNull_diaChi = 1 AND [diaChi] IS NULL) OR ([diaChi] = @Original_diaChi)));
SELECT maNV, tenNV, gioiTinh, ngaySinh, SDT, diaChi FROM NhanVien WHERE (maNV = @maNV)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT maNV, tenNV, gioiTinh, ngaySinh, SDT, diaChi FROM dbo.NhanVien";
        ...
        public virtual int Insert(string maNV, string tenNV, string gioiTinh, global::System.Nullable<global::System.DateTime> ngaySinh, string SDT, string diaChi) {
            if ((maNV == null)) {
        ...
        public virtual int Update(string maNV, string tenNV, string gioiTinh, global::System.Nullable<global::System.DateTime> ngaySinh, string SDT, string diaChi, string Original_maNV, string Original_tenNV, string Original_gioiTinh, global::System.Nullable<global::System.DateTime> Original_ngaySinh, string Original_SDT, string Original_diaChi) {
            if ((maNV == null)) {
                throw new global::System.ArgumentNullException("maNV");
            }
            else {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string tenNV, string gioiTinh, global::System.Nullable<global::System.DateTime> ngaySinh, string SDT, string diaChi, string Original_maNV, string Original_tenNV, string Original_gioiTinh, global::System.Nullable<global::System.DateTime> Original_ngaySinh, string Original_SDT, string Original_diaChi) {
            return this.Update(Original_maNV, tenNV, gioiTinh, ngaySinh, SDT, diaChi, Original_maNV, Original_tenNV, Original_gioiTinh, Original_ngaySinh, Original_SDT, Original_diaChi);
        }
    }
    ...
    public partial class RoleTableAdapter : global::System.ComponentModel.Component {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Fill, true)]
        public virtual int Fill(QLNhanVienDataSet.RoleDataTable dataTable) {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            if ((this.ClearBeforeFill == true)) {
                dataTable.Clear();
            }
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Select, true)]
        public virtual QLNhanVienDataSet.RoleDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            QLNhanVienDataSet.RoleDataTable dataTable = new QLNhanVienDataSet.RoleDataTable();
            this.Adapter.Fill(dataTable);
            return dataTable;
        }
    }
