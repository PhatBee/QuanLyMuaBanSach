...
namespace QuanLyMuaBanSach
{
    internal class MyDB
    {
        private static string sqlcon = "Data Source=DESKTOP-N56ISCF\\TAMA;Initial Catalog=QLNhaSach;Integrated Security=True;Connect Timeout=30;Encrypt=True;TrustServerCertificate=True;ApplicationIntent=ReadWrite;MultiSubnetFailover=False";
